				...
				<div class="Form">
					...
					<div class="inputBlock">
						<div class="Form__input">
							<img src="../assets/svg/Login.svg" class="inputImg" draggable="false" ondragstart="return false;" alt="loginlogo" />
							<p>Логин</p>
						</div>
						<input type="text" v-model="login" placeholder="Введите логин" class="input" />
					</div>

					<div class="inputBlock">
						<div class="Form__input">
							<img src="../assets/svg/Password.svg" class="inputImg" draggable="false" ondragstart="return false;" alt="passlogo" />
							<p>Пароль</p>
						</div>
						<input type="password" v-model="pass" placeholder="🞄🞄🞄🞄🞄🞄🞄🞄🞄🞄" class="input" />
					</div>

					<div class="Form__EnterBtn">
						<button class="Form__button" @click="SingIN">Войти</button>
					</div>
				</div>
				<p class="Form__loginFail" :class="{ 'Form__loginFail--show': loginFailed }">Неверный логин или пароль</p>
			</form>
		</div>
		<div class="Container__SvgBlock">
			<div class="Container__logo">
				<img src="../assets/svg/SignInLogo.svg" draggable="false" ondragstart="return false;" alt="Artlogo" />
			</div>
		</div>
	</div>
</template>
	...
	methods: {
		...
		SingIN() {
			...
			for (let i in this.credentials) {
				if (this.credentials[i].Логин == this.login && this.credentials[i].Пароль == this.pass) {
